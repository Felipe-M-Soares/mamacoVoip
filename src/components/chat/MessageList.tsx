  ...
  if (messages.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <h3 className="text-xl font-bold text-white">Bem-vindo a #{channelName}!</h3>
        <p className="text-discord-text-muted mt-1 max-w-sm">Este é o começo do canal #{channelName}.</p>
      </div>
    )
  }
